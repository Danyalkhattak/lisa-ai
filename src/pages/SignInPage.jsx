...
/**
 * SignInPage — Premium Authentication
 * 
 * Design Philosophy:
          ...
          <SignIn 
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: "!bg-[#18181B] !border-white/15 !text-white !rounded-xl focus:!border-violet-500 focus:!ring-2 focus:!ring-violet-500/25 !px-4 !py-3 !text-sm !transition-all",
                formButtonPrimary: "!bg-gradient-to-r !from-violet-500 !via-purple-500 !to-fuchsia-500 hover:!from-violet-600 hover:!to-fuchsia-600 !text-white !font-semibold !normal-case !rounded-xl !shadow-lg !shadow-violet-500/30 !transition-all !py-3.5",
