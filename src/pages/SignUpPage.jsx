          ...
          <SignUp 
            appearance={{
              ...
              elements: {
                ...
                headerTitle: "!text-xl sm:!text-2xl !font-bold !text-white !font-['Space_Grotesk',sans-serif] !mb-1",
                headerSubtitle: "!text-gray-500 !text-xs !leading-relaxed",
                header: "!block !mb-6",
                socialButtonsBlockButton: "!bg-white/[0.08] hover:!bg-white/15 !border-white/20 hover:!border-white/30 !text-white !font-medium !rounded-xl !transition-all !py-2.5 !w-full !max-w-full !box-border",
                socialButtonsBlockButtonText: "!text-white !font-medium !text-sm",
                socialButtonsBlockButtonArrow: "!text-white",
                formFieldLabel: "!text-gray-300 !text-xs !font-medium !mb-1.5 !block",
                formFieldInput: "!bg-[#18181B] !border-white/15 !text-white !rounded-xl focus:!border-fuchsia-500 focus:!ring-2 focus:!ring-fuchsia-500/25 !px-3.5 !py-2.5 !text-sm !transition-all !w-full !max-w-full !box-border",
                formButtonPrimary: "!bg-gradient-to-r !from-fuchsia-500 !via-pink-500 !to-orange-500 hover:!from-fuchsia-600 hover:!to-orange-600 !text-white !font-semibold !normal-case !rounded-xl !shadow-lg !shadow-fuchsia-500/30 !transition-all !py-3 !w-full !max-w-full !box-border",
                ...
                dividerText: "!text-gray-500 !text-xs !bg-transparent",
