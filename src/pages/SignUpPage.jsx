  ...
  return (
    <div className="min-h-screen bg-[#09090B] flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        {/* 👇 Card container removed – SignUp renders directly on the background */}
        <SignUp 
          appearance={{
            variables: {
              colorPrimary: "#D946EF",
            ...
            elements: {
              ...
              formFieldInput: "!bg-[#18181B] !border-white/15 !text-white !rounded-xl focus:!border-fuchsia-500 focus:!ring-2 focus:!ring-fuchsia-500/25 !px-4 !py-3 !text-sm !transition-all !w-full !max-w-full !box-border",
              formButtonPrimary: "!bg-gradient-to-r !from-fuchsia-500 !via-pink-500 !to-orange-500 hover:!from-fuchsia-600 hover:!to-orange-600 !text-white !font-semibold !normal-case !rounded-xl !shadow-lg !shadow-fuchsia-500/30 !transition-all !py-3.5 !w-full !max-w-full !box-border",
